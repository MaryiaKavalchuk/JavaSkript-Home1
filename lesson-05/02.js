...
function updateGallery(objectGallery,key,newName) {
  objectGallery[key] = newName
}
updateGallery(gallery, 'Mona Lisa', 'Leonardo da Vinci, 1503-1506')
updateGallery(gallery, 'The Persistence of Memory', 'Salvador Dali')
...
// function updateGallery(objectGallery, key, newName) {
//   if (key in objectGallery) {
//     // Если произведение уже существует, обновляем его
//     objectGallery[key] = newName;
//   } else {
//     // Если произведения нет, добавляем его
//     objectGallery[key] = newName;
//   }
// }
